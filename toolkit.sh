#!/usr/bin/env bash
#
# Toolkit - Central CLI & Interactive Management Script
# https://github.com/Kotsasmin/toolkit
#

set -uo pipefail

# Determine script root directory (handles symlinks gracefully)
...
# Run a script with optional sudo elevation check
# Usage: execute_script <file_path> <needs_root: true|false> <interactive: true|false> [script_args...]
execute_script() {
    local target="$1"
